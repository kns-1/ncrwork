...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(164, 121);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(129, 23);
			this->button1->TabIndex = 0;
			this->button1->Text = L"Remove Duplicates";
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(228, 59);
			...
			this->Name = L"MyForm";
			this->Text = L"File System Maintenance";
